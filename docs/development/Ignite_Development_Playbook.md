...
docs/
  product/
    PRD.md                              # Canonical product source of truth
  development/
    Ignite_Development_Playbook.md      # This playbook — how we build and verify
  architecture/
    decisions/                          # Architecture Decision Records (when needed)
  operations/                           # Operational runbooks (when needed)
  testing/                              # Test-strategy notes (when needed)

ARCHITECTURE.md                         # Engineering layout (repo root)

.cursor/
  rules/                                # Short, always-on agent guardrails
```
...
Do not duplicate the PRD here. Product requirements, domain rules, architecture, persistence, security, privacy, testing, and roadmap remain in `docs/product/PRD.md`.
